/************************************************************************
  ...
  PicoHarp 200    PHLIB  Interactive Mode Routing Demo in C
...
int main(int argc, char* argv[])
{
 ...
 printf("\nPicoHarp 300   PHLib   Routing Demo        M. Wahl, PicoQuant GmbH, 2009");
 printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
 ...
 { 
        ...
        for(i=0; i<4; i++) //loop through the routing channels to fetch the data
        {
				...
				printf("\nTotal count in channel %1d = %9lld",i+1,Integralcount);
        }
